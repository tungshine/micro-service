...
import com.tanglover.zuul.cache.RedisCache;
import com.tanglover.zuul.cache.RedisKeyConstants;
import com.tanglover.zuul.config.Configuration;
import com.tanglover.zuul.utils.RegularUtil;
...
public class IpUtils {
    ...
    public boolean RecordIPAndCount(String ip, Long expireSeconds, int allow_count) {
        ...
        String key = RedisKeyConstants.getCacheKey(RedisKeyConstants.getIpForbiddenEmailPrefix(), ip);
